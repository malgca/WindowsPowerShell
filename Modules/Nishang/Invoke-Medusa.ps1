...
.EXAMPLE
.\Invoke-Medusa.ps1 -Identity SRV01 -UserName sa -Password ""

.EXAMPLE
.\Invoke-TSMedusa.ps1 -Identity ftp://SRV01 -UserName sa -Password "" -Service FTP

.EXAMPLE
"SRV01","SRV02","SRV03" | .\Invoke-Medusa.ps1 -UserName sa -Password sa

.EXAMPLE
.\Invoke-Medusa.ps1 -Identity "domain.local" -UserName administrator -Password Password1 -Service ActiveDirectory

.EXAMPLE
.\Invoke-Medusa.ps1 -Identity "http://www.something.com" -UserName user001 -Password Password1 -Service Web
